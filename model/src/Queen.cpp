...
Queen::Queen(sf::Texture& pieceTexture, int x, int y, PieceColor pieceColor)
    : Piece(pieceTexture, x, y, pieceColor, PieceType::QUEEN)
{

}

void Queen::calculateValidMoves(BoardType board, bool simulateMoves) const
{
    m_validMoves.clear();
