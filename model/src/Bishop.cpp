...
Bishop::Bishop(sf::Texture& pieceTexture, int x, int y, PieceColor pieceColor)
    : Piece(pieceTexture, x, y, pieceColor, PieceType::BISHOP)
{

}

void Bishop::calculateValidMoves(BoardType board, bool simulateMoves) const
{
    m_validMoves.clear();
